      ...
      <div className="fixed inset-0 z-50 overflow-y-auto bg-neutral-50 text-neutral-900 flex flex-col select-none font-sans">
        ...
        <div className="w-full bg-white px-6 py-4 flex items-center justify-between border-b border-neutral-200 shadow-sm sticky top-0 z-40 flex-shrink-0">
          <div className="flex items-center gap-4">
            ...
            <h2 className="font-condensed font-black text-xl md:text-2xl text-neutral-900 tracking-wide uppercase">
        ...
        {successMessage ? (
          <div className="flex-grow flex items-center justify-center p-6 bg-neutral-50 animate-fadeIn">
            <div className="bg-white border border-neutral-200 text-neutral-900 rounded-2xl p-8 text-center space-y-6 shadow-xl max-w-[500px] w-full border-t-4 border-t-[#C5A059]">
              ...
              <h5 className="font-condensed font-black text-2xl uppercase tracking-wider text-neutral-900">Request Received</h5>
            ...
            <div className="max-w-[1160px] w-full mx-auto space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 animate-fadeIn">
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <div>
                        <h3 className="font-condensed font-black text-xl text-neutral-900 leading-snug uppercase">
                          No extra protection
                        </h3>
                        {/* Stars */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 text-left animate-fadeIn">
                  ...
                  <div className="lg:col-span-4">
                    <div className="bg-[#f8f8f8] border border-neutral-200 rounded-2xl p-6 space-y-5 text-left sticky top-24">
                      <h4 className="font-condensed font-black text-lg uppercase tracking-wider text-neutral-900">
              ...
              {step === 4 && (
                <div className="max-w-[700px] mx-auto bg-white border border-neutral-200 rounded-2xl p-8 space-y-6 text-left animate-fadeIn">
                  <div>
                    <h4 className="font-condensed font-black text-2xl uppercase text-neutral-900">Complete Reservation Intake</h4>
              ...
              {(step === 2 || step === 4) && (
                <div className="bg-[#EAEAEA]/30 border border-neutral-200/50 p-6 rounded-2xl text-left space-y-4">
                  <h4 className="font-condensed font-black text-[15px] uppercase tracking-wider text-neutral-900">
                    Your booking overview:
                  </h4>
          ...
          {successMessage ? (
            <div className="flex flex-col h-full justify-center py-8">
              <div className="bg-neutral-900 border border-neutral-800 text-white rounded-2xl p-8 text-center space-y-6 shadow-xl max-w-[500px] mx-auto border-t-4 border-t-[#C5A059]">
                ...
                <h5 className="font-condensed font-black text-2xl uppercase tracking-wider text-white">Request Received</h5>
            ...
            <>
              {step === 1 && (
                <div className="flex flex-col h-full justify-between">
                  <div className="space-y-6">
                    <div>
                      <h4 className="font-condensed font-black text-2xl uppercase text-white">Configure Booking Options</h4>
                      <p className="text-xs text-neutral-400 mt-1">Customize flexibility options and kilometer allowances.</p>
                    </div>

                    <div className="space-y-3">
                      <h5 className="text-xs font-black text-neutral-400 uppercase tracking-wider">Booking option</h5>
                    ...
                    <div className="space-y-3 pt-2">
                      <h5 className="text-xs font-black text-neutral-400 uppercase tracking-wider">Mileage Allowance</h5>
                      <div className="space-y-2">
                        <label 
              ...
              {step === 2 && (
                <div className="flex flex-col h-full justify-between">
                  <div className="space-y-6">
                    <div>
                      <h4 className="font-condensed font-black text-2xl uppercase text-white">Choose protection package</h4>
              ...
              {step === 3 && (
                <div className="flex flex-col h-full justify-between">
                  <div className="space-y-6">
                    <div>
                      <h4 className="font-condensed font-black text-2xl uppercase text-white">Select premium add-ons</h4>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                      ...
                      <div className="lg:col-span-5 bg-neutral-900/60 border border-neutral-800 rounded-xl p-4 space-y-3">
                        <h5 className="text-[9px] font-black text-neutral-400 uppercase tracking-widest border-b border-neutral-800 pb-2">Inclusive Features</h5>
              ...
              {step === 4 && (
                <div className="flex flex-col h-full justify-between">
                  <div className="space-y-6">
                    <div>
                      <h4 className="font-condensed font-black text-2xl uppercase text-white">Complete Reservation Intake</h4>
